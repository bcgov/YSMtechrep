...
date: "Version 2026-09-17; Created `r Sys.Date()`"
#runtime: shiny
...
8. For YSM measurements since 2017, the impact from stem rusts can be 
    ...
    **`r colorize(stemrustimpact100, "red")`** `r colorize("(% of m^3^/ha)", "red")`
...
grid::grid.draw(projvol_sp_prop_2())
```
